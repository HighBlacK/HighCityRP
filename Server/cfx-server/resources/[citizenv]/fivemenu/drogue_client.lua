...
AddEventHandler("menudrogue:DrogueOG", function(target)
  ...
  VMenu.curItem = 1
  VMenu.AddFunc(26 ,"Acheter des informations", "menudrogue:info",{0},"Acheter")
end)
...
AddEventHandler("menudrogue:info_weed",function()
  ...
  VMenu.ResetMenu(26, "", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(26,"Acheter des informations sur la weed","menudrogue:infoweed",{0},"Acheter")
end)
...
AddEventHandler("menudrogue:info_coke",function()
  ...
  VMenu.curItem = 1
  VMenu.AddFunc(27,"Acheter des informations sur la coke","menudrogue:infocoke",{0},"Acheter")
end)
...
AddEventHandler("menudrogue:info_meth",function()
  ...
  VMenu.curItem = 1
  VMenu.AddFunc(28,"Acheter des informations sur la meth","menudrogue:infometh",{0},"Acheter")
end)

AddEventHandler("menudrogue:info_organe",function()
  TriggerServerEvent("menudrogue:getCash_s")
  VMenu.ResetMenu(29, "", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(29,"Acheter des informations sur les organes","menudrogue:infoorg",{0},"Acheter")
end)
...
AddEventHandler("menudrogue:infocoke",function()
  VMenu.ResetMenu(27, "", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(27,"Retour","menudrogue:info_coke",{},"Retour")
  if cashycash >= coke[1].cost then
    VMenu.AddFunc(27,"Acheter le champs de coke","menudrogue:coke",{0},"Acheter")
  end
  if cashycash >= coke[2].cost then
    VMenu.AddFunc(27,"Acheter le traitement de coke","menudrogue:coke",{1},"Acheter")
  end
  if cashycash >= coke[3].cost then
    VMenu.AddFunc(27,"Acheter la vente de coke","menudrogue:coke",{2},"Acheter")
  end
  if cashycash < coke[1].cost and cashycash < coke[2].cost and cashycash < coke[3].cost then
    VMenu.AddSep(27, "Vous n'avez pas assez d'argent")
  end
end)
...
AddEventHandler("menudrogue:infometh",function()
  VMenu.ResetMenu(28, "Informateur", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(28,"Retour","menudrogue:info_meth",{},"Retour")
  if cashycash >= meth[1].cost then
    VMenu.AddFunc(28,"Acheter le champs de meth","menudrogue:meth",{0},"Acheter")
  end
  if cashycash >= meth[2].cost then
    VMenu.AddFunc(28,"Acheter le traitement de meth","menudrogue:meth",{1},"Acheter")
  end
  if cashycash >= meth[3].cost then
    VMenu.AddFunc(28,"Acheter la vente de meth","menudrogue:meth",{2},"Acheter")
  end
  if cashycash < meth[1].cost and cashycash < meth[2].cost and cashycash < meth[3].cost then
    VMenu.AddSep(28, "Vous n'avez pas assez d'argent")
  end
end)
...
AddEventHandler("menudrogue:infoorg",function()
  VMenu.ResetMenu(29, "Informateur", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(29,"Retour","menudrogue:info_organe",{},"Retour")
  if cashycash >= organe[1].cost then
    VMenu.AddFunc(29,"Où récolter des organes","menudrogue:org",{0},"Acheter")
  end
  if cashycash >= organe[2].cost then
    VMenu.AddFunc(29,"Acheter les traitements d'organes","menudrogue:org",{1},"Acheter")
  end
  if cashycash >= organe[3].cost then
    VMenu.AddFunc(29,"Acheter la vente d'organes","menudrogue:org",{2},"Acheter")
  end
  if cashycash < organe[1].cost and cashycash < organe[2].cost and cashycash < organe[3].cost then
    VMenu.AddSep(29, "Vous n'avez pas assez d'argent")
  end
end)
...
AddEventHandler("menudrogue:infoweed",function()
  VMenu.ResetMenu(26, "Informateur", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(26,"Retour","menudrogue:info_weed",{},"Retour")
  if cashycash >= weed[1].cost then
    VMenu.AddFunc(26,"Acheter champs de weed","menudrogue:weed",{0},"Acheter")
  end
  if cashycash >= weed[2].cost then
    VMenu.AddFunc(26,"Acheter le traitement de weed","menudrogue:weed",{1},"Acheter")
  end
  if cashycash >= weed[3].cost then
    VMenu.AddFunc(26,"Acheter la vente de weed","menudrogue:weed",{2},"Acheter")
  end
  if cashycash < weed[1].cost and cashycash < weed[2].cost and cashycash < weed[3].cost then
    VMenu.AddSep(26, "Vous n'avez pas assez d'argent")
  end
end)
