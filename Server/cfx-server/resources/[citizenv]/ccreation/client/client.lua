...
RegisterNUICallback('login', function(data, cb)
		...
		TriggerServerEvent("ply_autoecole:Userlicencev", false)
		--DisplayNotification("Bienvenu sur ~r~HighCityRP~s~" "~n~".. data.username .. "" .. data.password)
		DisplayNotification("Votre prénom: " .. data.username .. "~n~Votre nom: " .. data.password)
	    ...
	    TriggerServerEvent("vmenu:lastChar")
			...
			TriggerEvent("itinerance:notif", "~r~Veuillez remplir tous les champs")
		end
    cb('ok')
end)
