...
files {
	...
	'files/img/characters/17.png',
	'files/img/characters/18.png',
	'files/img/characters/19.png',
	'files/img/characters/20.png',
	'files/img/characters/21.png',
	'files/img/characters/22.png',
	'files/img/characters/23.png',
	'files/img/characters/24.png',
    'files/img/logo.png',
	'files/img/loadinghead.png',
	'files/img/loadingring.gif',
	'files/img/loadingtxt.png',
}
