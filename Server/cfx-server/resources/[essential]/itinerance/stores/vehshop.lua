	...
	menu = {
		...
		["compacts"] = {
			...
			buttons = {
				...
				{name = "Dilettante", costs = 2500000, description = {}, model = "Dilettante"},
			}
		},
		["coupes"] = {
			title = "coupes",
		...
		["super"] = {
			...
			buttons = {
				...
				{name = "Voltic", costs = 3500000, description = {}, model = "voltic"},
			}
		},
		["muscle"] = {
			title = "muscle",
...
local vehshop_locations = {{entering = {-33.8176,-1114.17,26.4224}, inside = {-41.0989,-1099.91,26.4224, 120.1953}, outside = {-31.849,-1090.648,25.998,322.345}, enteringtwo = {-29.9893,-1103.84,26.4224}}}
local vehshop_blips ={}
...
function ShowVehshopBlips(bool)
	if bool and #vehshop_blips == 0 then
		for station,pos in pairs(vehshop_locations) do
			...
			AddTextComponentString('~b~Concessionnaire')
		...
		Citizen.CreateThread(function()
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					...
					if vehshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 2 then
						DisplayHelp('Appuyer sur ~INPUT_CONTEXT~ pour acheter un véhicule', false)
						--drawTxt('Appuyer sur ~g~Entrée~s~ pour accéder au menu d\'achat',1, 2, 0.5, 0.9, 0.6, 255, 255, 255, 255)
						currentlocation = b
						inrange = true
					elseif vehshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.enteringtwo[1],b.pos.enteringtwo[2],b.pos.enteringtwo[3],GetEntityCoords(LocalPed())) < 2 then
						DisplayHelp('Appuyer sur ~INPUT_CONTEXT~ pour acheter un véhicule', false)
						currentlocation = b
						inrange = true
					end
