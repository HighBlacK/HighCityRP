...
Citizen.CreateThread(function()
  ...
  --  SetBlipTrade(210, "~g~Ferme", 2, Position.Recolet.x, Position.Recolet.y, Position.Recolet.z)
  ...
  --  SetBlipTrade(402, "Traitement de tomates", 2, Position.traitementt.x, Position.traitementt.y, Position.traitementt.z)
    ...
    --SetBlipTrade(52, "~g~Supermaché", 2, Position.vente.x, Position.vente.y, Position.vente.z)
...
Citizen.CreateThread(function()
	while true do
	Citizen.Wait(1)
    DrawMarker(1,2243.6,5154.26,56.8869, 0, 0, 0, 0, 0, 0, 3.001, 3.0001, 0.5001, 0, 255, 0, 200, 0, 0, 0, 0)
		if GetDistanceBetweenCoords(2251.38,5155.5,57.8871,GetEntityCoords(LocalPed())) < 3 then
          ShowInfo('Appuyer sur ~INPUT_CONTEXT~ pour enfiler votre ~b~tenue de travail',0)
        ...
        --else
		  --ShowInfo('Appuyer sur ~g~ENTRÉE~s~ pour ranger votre ~b~tenue de travail',0)
...
Citizen.CreateThread(function()
	while true do
	Citizen.Wait(1)
    DrawMarker(1,2251.38,5155.5,56.8871,0,0,0,0,0,0,2.001,2.0001,0.5001,0,255,0,200,0,0,0,0)
...
Citizen.CreateThread(function()
    ...
    if not IsInVehicle() then
      if distance < Position.Recolet.distance then
        ShowInfo('Appuyez sur ~INPUT_CONTEXT~ pour ~b~récolter', 0)
        if IsControlJustPressed(1, 38) then
          TriggerServerEvent("poleemploi:getjobs")
          Wait(100)
          if myjob == 14 then
